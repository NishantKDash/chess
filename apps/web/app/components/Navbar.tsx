          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center">
              <div className="flex items-center ms-3">
                <div className="text-white mx-2">Hi User</div>
          ...
          <ul className="space-y-2 font-medium">
            <li>
              ...
              >
                ...
                <span className="flex-1 ms-3 whitespace-nowrap">PVP</span>
              </a>
            </li>
            <li>
              <a
            ...
            <li>
              ...
              >
                ...
                <Link href="./signup" className="flex-1 ms-3 whitespace-nowrap">
                  Sign Up
                </Link>
              </a>
            </li>
